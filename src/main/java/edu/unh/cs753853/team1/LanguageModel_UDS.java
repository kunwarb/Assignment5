...
/**
 * Encapsulates the idea of the run file string and splits it into separate
 * parts. Written by Austin. I'm just borrowing it since we should stay
 * consistent.
 * 
 * @author amf2015
 */
class RunFileString {
	...
	/**
	 * Creates the default runfile string. For this implementation, teamName and
	 * methodName are fixed at "team1" and "DS-Dirichlet" respectively.
	 */
	RunFileString() {
		queryId = "";
		paraId = "";
	...
	/**
	 * Create a runfile string with the given properties. teamName and
	 * methodName left out because they will be similar across the board for
	 * this program.
	 *
	 * @param qid
	 *            The Page Name used as the queryId
	 * @param pid
	 *            The paragraph Id
	 * @param r
